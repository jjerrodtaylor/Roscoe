 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     ?>
      <tr>
            <td class="paging">
			 <?php
			    echo $paginator->prev($html->image('aro_left.png', array('border' => '0')), array('escape' => false));
			   // echo $paginator->numbers();			           
			    echo $paginator->next($html->image('aro_right.png', array('border' => '0')), array('escape' => false));
			  ?>				
		 </td>
		</tr>
	<?php 
