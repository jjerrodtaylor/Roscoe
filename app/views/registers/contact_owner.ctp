	...
	<div class="InnerMidCntR">
		...
		<h2 class="InnerMidCntRHd">Owner Information</h2>
											...
											<tr>
												<td>
													...
													<li>
														...
														<span class="MyAccTxtVal"><a href="mailto:<?php echo $data['User']['email']; ?>"><span class="special"><?=$data['User']['email']?></span></a></span>
													</li>													
													<?php 
